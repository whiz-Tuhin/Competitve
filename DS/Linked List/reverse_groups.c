...
NODE* reverse_groups(NODE* head,int size)
{
   NODE* prev = NULL;
   NODE* current = head;
   NODE* next;
  ...
  //i have to reverse the rest of the list
...
int main()
{
	...
	int choice,choice2,group_size;
	int data =0,key =0,pos =0,j=0;
